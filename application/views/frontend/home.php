  ...
  <div class="container">
    <div class="row ">
      ...
      <div class="col-lg-6 order-2 order-lg-1">
        <img width="50%" height="60%" class="img-fluid mb-4" src="<?php echo base_url(); ?>assets/img/logo.png" alt="Image">
      </div>
      <div class="col-lg-6 order-3 pl-lg-5 order-lg-2">

        <strong class="text-black">Clinico Shoes</strong>

        <p>Clinico Shoes adalah usaha yang bergerak dibidang jasa pencucian khusus sepatu.</p>
  ...
  <div class="container">
    <div class="row mb-5">
      <div class="col-12 position-relative">
        <h2 class="section-title text-center mb-5">My Gallery</h2>
      </div>
    </div>
    ...
    <div class="row">
      ...
      <div class="col-md-6 col-lg-4 item">
        ...
        <a href="<?php echo base_url(); ?>assets/img/img5.jpg" class="item-wrap fancybox mb-4">
          <span class="icon-search2"></span>
          <img class="img-fluid" src="<?php echo base_url(); ?>assets/img/img5.jpg">
        </a>
        <a href="<?php echo base_url(); ?>assets/img/img6.jpg" class="item-wrap fancybox mb-4">
          <span class="icon-search2"></span>
          <img class="img-fluid" src="<?php echo base_url(); ?>assets/img/img6.jpg">
        </a>
      </div>
      <div class="col-md-6 col-lg-4 item">
