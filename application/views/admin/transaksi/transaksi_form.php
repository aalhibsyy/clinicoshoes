                ...
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <div class="card-body card-block">
                            <form action="<?php echo base_url() . 'admin/transaksi/simpan_transaksi' ?>" method="post">
                                <div class="row">
                                    <div class="col-md-8">
                                        ...
                                        <div class="row form-group">
                                            <div class="col col-md-3">
                                                <label class=" form-control-label text-right">Pilih Staff :</label>
                                            </div>
                                            <div class="col-12 col-md-8">
                                                <select required name="id_staff" class="form-control">
                                                    <option value="" disabled diselected>-- Pilih Staff--</option>
                                                    <?php
                                        ...
                                        <div class="row form-group">
                                            <div class="col col-md-3">
                                                <label for="text-input" class=" form-control-label text-right">Pelanggan :</label>
                                            </div>
                                            <div class="col-12 col-md-8">
                                                <input required list="list_barang" class="form-control reset" placeholder="ID atau Nama Pelanggan ..." name="id_barang" id="id_barang" autocomplete="off" onchange="showPelanggan(this.value)">
                                        ...
                                        <div id="barang">
                                            ...
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label class=" form-control-label text-right">Alamat :</label>
                                                </div>
                                                <div class="col-12 col-md-8">
                                                    <input type="text" class="form-control reset" name="alamat" id="alamat" readonly="readonly">
                                                </div>
                                            </div>
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                    ...
                                    <div class="col-md-4 mb">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="form-group">
                                                <label for="bayar" class="besar"><b>Bayar (Rp) :</b></label>
                                                <input type="text" id="jml_uang" name="jml_uang" placeholder="0" autocomplete="off" class="jml_uang form-control input-sm" style="text-align:right;margin-bottom:5px;" required>
                                                <input type="hidden" id="jml_uang2" name="jml_uang2" class="form-control input-sm" style="text-align:right;margin-bottom:5px;" required>
                                            </div>
                                            <div class="form-group">
                                                <label for="kembali" class="besar"><b>Kembali (Rp) :</b></label>
                                                <input readonly type="text" id="kembalian" name="kembalian" class="form-control input-sm" placeholder="0" style="text-align:right;margin-bottom:5px;" required>
                                            </div>
                            ...
                            <tbody>
                                ...
                                <?php foreach ($this->cart->contents() as $items) : ?>
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align:center;"><a href="<?php echo base_url() . 'admin/transaksi/remove/' . $items['rowid']; ?>" class="btn btn-warning btn-sm"><span class="fa fa-close"></span> Batal</a></td>
                                    </tr>
