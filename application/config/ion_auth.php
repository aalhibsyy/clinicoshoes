 ...
 */
$config['site_title']                 = "Clinico Shoes";       // Site Title, example.com
$config['admin_email']                = "admin@example.com"; // Admin Email, admin@example.com
$config['default_group']              = 'members';           // Default group, use name
$config['admin_group']                = 'admin';             // Default administrators group, use name
$config['staff_group']                = 'staff';             // Default administrators group, use name
$config['members_group']              = 'members';             // Default administrators group, use name
