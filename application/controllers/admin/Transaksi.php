...
class Transaksi extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $data['pelanggan'] = $this->mod_pelanggan->get_user();
        $data['staff'] = $this->mod_pelanggan->get_all();
        $this->template->load('template/backend/dashboard', 'admin/transaksi/transaksi_form', $data);
    }
    function get_barang()
    {
    ...
    function simpan_transaksi()
    {
        ...
        $id_pelanggan = $this->input->post('id_barang');
        ...
        if (!empty($total) && !empty($jml_uang)) {
            if ($jml_uang < $total) {
                ...
                if ($order_proses) {
                    ...
                    <a class="btn btn-default" href="' . base_url() . 'transaksi"><span class="fa fa-backward"></span>Kembali</a>
                    <a class="btn btn-info" href="' . base_url() . 'transaksi/cetak_faktur" target="_blank"><span class="fa fa-print"></span>Cetak</a>
                </div>');
                    redirect(site_url('transaksi'));
    ...
    {
        $pelanggan = $this->mod_pelanggan->user_get_by_id($id);
        if ($pelanggan) {
        ...
        <div class="row form-group">
            ...
            <div class="col-12 col-md-8">
                <input type="text" class="form-control reset" name="alamat" id="alamat" readonly="readonly" value="' . $pelanggan->address . '">
            </div>
        </div>
        <div class="row form-group">
            <div class="col col-md-3">
